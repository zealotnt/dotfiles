...
if [[ $# == 0 ]]; then
  ...
  if [[ "$1" == "0" ]]; then
    ...
    python /home/zealot/workspace_misc/rm3_mini_controller/BlackBeanControl.py -c SetAirConOldDaikin26
  elif  [[ "$1" == "27OldDaikin" ]]; then
    python /home/zealot/workspace_misc/rm3_mini_controller/BlackBeanControl.py -c SetAirConOldDaikin27
  elif  [[ "$1" == "28OldDaikin" ]]; then
    python /home/zealot/workspace_misc/rm3_mini_controller/BlackBeanControl.py -c SetAirConOldDaikin28
  elif  [[ "$1" == "27" ]]; then
